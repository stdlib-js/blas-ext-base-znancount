...
```javascript
znancount = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-znancount@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var znancount = require( 'path/to/vendor/umd/blas-ext-base-znancount/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-znancount@umd/browser.js"></script>
```
